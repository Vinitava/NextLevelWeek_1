...
const CreatePoint = () => {
    ...
    useEffect(() => {
        axios.get<IIBGECidadeResponse[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectedUf}/distritos`).then(response => {
                ...
                <fieldset>
                    ...
                    <div className="field-group">
                        ...
                        <div className="field">
                            ...
                            <select disabled={selectedUf === '0'} name="city" id="city" value={selectedCity} onChange={handleSelectCity} >
